...
export const projects = [
    ...
    },
    {
        ...
        desc: `Kenisce Group has a system of affairs for clients that ensure excellent output. For every service we 
               ...
               Group has all you need to make super gains, the likes you’ve never seen before.`
    },
    {
        name: "Repo Automator",
        role: "Backend",
    ...
    },
    {
        ...
        role: "Backend",
        stacks: ["Python", "PostgreSQL", "DRF", "Redis", "Celery"],
        link: "https://hndwok.com/",
        desc: `This project connects freelancers and artisans to employers and job providers within Nigeria. `
    },
];

export const reviews = [
    {
        name: "Onochie Jon-Igwesi",
        picture: "onochie",
        position: "Chairman, The Pacesetter Frontier",
        review: `Working with Mark Eke was an absolute pleasure. He's attention to details and ability to meet tight 
                 deadlines was impressive. He was always quick to respond to any questions I had and went above and 
    ...
    },
    {
        ...
        review: `If you're looking for a web developer who is not only skilled but also passionate about his/her work, 
